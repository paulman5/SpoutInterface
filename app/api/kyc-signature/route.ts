...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log("  - Pharos Testnet: 0xA5C77b623BEB3bC0071fA568de99e15Ccc06C7cb")
    console.log("  - Problematic address: 0x369B11fb8C65d02b3BdD68b922e8f0D6FDB58717")
    
    if (data.issuerAddress === "0x369B11fb8C65d02b3BdD68b922e8f0D6FDB58717") {
      console.warn("⚠️ WARNING: External API returned the problematic address!")
    }
